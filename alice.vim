...
syn keyword alice_word while do fi if then efi ifelse else fun var const swap clear drop over rot eq lf gt and or ln length include exists type exit ssize random charat readf time get break continue return eval writef readf
